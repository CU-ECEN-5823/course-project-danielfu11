...
if [[ -z ${PATH_GCCARM} ]]; then
  OBJCOPY="/home/gufu/Desktop/SimplicityStudio_v4/developer/toolchains/gnu_arm/4.9_2015q3/bin/arm-none-eabi-objcopy"
...
if [[ -z ${PATH_SCMD} ]]; then
  COMMANDER="/home/gufu/Desktop/SimplicityStudio_v4/developer/adapter_packs/commander/commander"
